...
public class MyItemContainer extends Container
{
    ...
    private static final int INV_START = MyItemInventory.INV_SIZE, INV_END = INV_START+26,
    ...
    public MyItemContainer(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, MyItemInventory myItemInventory)
    {
        this.inventory = myItemInventory;
        ...
        for (i = 0; i < MyItemInventory.INV_SIZE; ++i)
        {
            ...
            this.addSlotToContainer(new MyItemInventorySlot(this.inventory, i, 80 + (18 * (int)(i/4)), 8 + (18*(i%4))));
        }
