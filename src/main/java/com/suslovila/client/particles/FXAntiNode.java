...
public class FXAntiNode extends EntityFX {
    ...
    public static final ResourceLocation particles = new ResourceLocation(ExampleMod.MOD_ID, "textures/particles/antiNodeFX.png");
    ...
    public FXAntiNode(World world, double d, double d1, double d2,  float size, float red, float green, float blue, boolean distanceLimit, boolean depthTest, float maxAgeMul) {
