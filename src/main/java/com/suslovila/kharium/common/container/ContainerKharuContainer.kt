...
class ContainerKharuContainer(val tile: TileKharuContainer, val player: EntityPlayer) : DefaultContainer() {

    init {
        addSlotToContainer(
            SlotKharuContainerItem(
                tile.inventory,
                0,
                232,
                80
    ...
    class SlotKharuContainerItem(inventory: IInventory, slotIndex: Int, x: Int, y: Int) :
