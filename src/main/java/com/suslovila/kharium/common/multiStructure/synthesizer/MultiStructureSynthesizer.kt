...
class SynthesizerElement(
    ...
    val correspondingComponentIndex: Int
) : MultiStructureElement<SynthesizerAdditionalData>(
    x, y, z, storedBlock, meta
) {
    override fun putAdditionalData() {
        this.additionalData = SynthesizerAdditionalData()
    }
...
class SynthesizerAdditionalData() : AdditionalData() {
