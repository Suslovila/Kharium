...
class BlockNettHandler(name: String
) : MultiStructureBlock<NetHandlerAdditionalDta, NetHandlerElement>() {
    override val multiStructure: MultiStructure<NetHandlerAdditionalDta, NetHandlerElement> by lazy { MultiStructureKharuSnare }
    ...
    override fun onBlockActivated(
        ...
        if(snare !is TileNetHandler) return false
